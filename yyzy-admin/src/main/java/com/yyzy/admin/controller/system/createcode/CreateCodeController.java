package com.yyzy.admin.controller.system.createcode;
...
import java.util.*;
/**
 * 类名称：FreemarkerController 创建人：mfw 创建时间：2015年1月12日
 * 
 * @version
 */
@Controller
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception {
		...
		for (int i = 0; i < zindex; i++) {
			fieldList.add(pd.getString("field" + i).split(",mfw,")); //属性放到集合里面
		}

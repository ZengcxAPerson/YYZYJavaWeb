...
<form action="hyxx/AddConsigneeServlet" method="post">
<table width="36%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 货源信息->收货管理->添加收货人</span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="452" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" height="254">
     <tr>
       <td width="112"  height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">收货人编号</span></div></td>
       <td width="327"  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
         <input type="text" name="consigneeNumber" size="25"/>
         </span></div>
         </td>
     </tr>
     <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
        	<input type="text" name="consigneeCompany" size="25"/>
        </span></div>
        </td>
     </tr>
     <tr>
     ...
     <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
          <input type="text" name="consigneePhone" size="25"/>
        </span></div>
        </td>
     </tr>
     <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
          <input type="text" name="consigneeMobile" size="25"/>
        </span></div>
        </td>
     </tr>
     <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
          <input type="text" name="consigneeFax" size="25"/>
        </span></div>
        </td>
     </tr>
     <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
          <input type="text" name="consigneeEmail" size="25"/>
        </span></div>
        </td>
     </tr>
     <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
          <input type="text" name="consigneeIdCard" size="25"/>
        </span></div>
        </td>
     </tr>

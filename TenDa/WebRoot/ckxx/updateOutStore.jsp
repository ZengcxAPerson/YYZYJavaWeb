...
<form action="ckxx/UpdateStoreOutServlet" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 仓库管理>>出库单管理>>修改出库单 </span></td>
              </tr>
            </table></td>
            <td><div align="right"><span class="STYLE1">
              <input type="image" src="images/add.gif" width="10" height="10" /> <span class="STYLE1"><input type="submit" value="修改">&nbsp;</span></div></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
      ...
      <%
       ...
       <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
        	<input type="text" name="StoreOutNum" value="<%= StoreOutNum %>" readonly="readonly" size="25"/>
        </span></div>
        </td>
     </tr>

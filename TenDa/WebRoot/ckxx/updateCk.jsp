...
<%
	String id = request.getParameter("wareHouseNumber");
 %>
<body>

<form action="ckxx/UpdateServlet" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 仓库管理>>添加仓库>>修改仓库 </span></td>
              </tr>
            </table></td>
    ...
    <tr>
      ...
      <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
        	<input type="text" name="wareHouseNumber" value="<%=id %>" readonly="readonly"  size="25"/>
        </span></div>
        </td>
     </tr>

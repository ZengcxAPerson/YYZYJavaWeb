...
<form action="ckxx/updateEntryStore" method="post">
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 仓库管理>>入库单管理>>修改入库单 </span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <%
  		String StoreEntryNum = request.getParameter("StoreEntryNum");
  	  %>
       <tr>
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">入库编号</span></div></td>
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
        	<input type="text" name="storeEntryNum" value="<%= StoreEntryNum %>" readonly="readonly" size="25"/>
        </span></div>
        </td>
     </tr>
      ...
      <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
        	<input type="text" name="storeEntryDate" size="25"/>
        </span></div>
        </td>
     </tr>
      ...
      <tr>
        ...
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">
        	<input type="text" name="goodsEntryAmount" size="25"/>
        </span></div>
        </td>
     </tr>
	 ...
	 <tr>
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">入库备注</span></div></td>
        <td  height="20" bgcolor="d3eaef" class="STYLE6"><div ><span class="STYLE10">

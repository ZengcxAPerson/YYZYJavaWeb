...
public class DelOutServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DelOutServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		boolean delOut = ckxxservice.delOut(storeOutNum);
		if(delOut)
		{	
			request.getRequestDispatcher("../ckxx/ShowOutStoreServlet").forward(request, response);
		}else{
			out.print(storeOutNum+"É¾³ýÊ§°Ü");
		}
	}

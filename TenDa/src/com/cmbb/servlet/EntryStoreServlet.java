...
public class EntryStoreServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public EntryStoreServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		GetPage page = ckxxservice.selectStoreEntryPage(nowdayPage1);
		request.setAttribute("page", page);

		RequestDispatcher rd= request.getRequestDispatcher("../ckxx/entryStore.jsp");

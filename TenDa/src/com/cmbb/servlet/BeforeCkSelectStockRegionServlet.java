...
public class BeforeCkSelectStockRegionServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public BeforeCkSelectStockRegionServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("addCkStockRegion.jsp").forward(request, response);
	}

...
public class ShowOutStoreServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ShowOutStoreServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		GetPage page = ckxxservice.selectStoreOutPage(nowdayPage1);
		request.setAttribute("page", page);
		
		
		RequestDispatcher rd= request.getRequestDispatcher("../ckxx/outStore.jsp");

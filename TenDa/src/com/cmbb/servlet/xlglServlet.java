...
public class xlglServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		dedicatedLineList=dao.selectDedicatedLine();
		request.setAttribute("dedicatedLineList",dedicatedLineList );
		request.getRequestDispatcher("../cdxx/xlgl.jsp").forward(request, response);

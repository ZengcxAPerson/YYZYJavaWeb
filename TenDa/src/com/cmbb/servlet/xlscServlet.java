...
public class xlscServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		boolean r=dao.delDedicatedLine(LineId);
		if(r){
			request.getRequestDispatcher("/cdxx/xlglServlet").forward(request, response);
		}else{

...
public class GetUpdateGoodsName extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetUpdateGoodsName() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("updateEntryStore.jsp").forward(request, response);
	}
